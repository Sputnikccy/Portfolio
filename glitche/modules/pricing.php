				...
				<div class="pricing-item content-box">
					...
					<div class="feature-list">
						<ul>
							...
							<li <?php if ( $row['line'] ) : ?>class="disable"<?php endif; ?>><?php echo esc_html( $row['text'] ); ?> <?php if ( $row['new'] ) : ?><strong><?php echo esc_html__( 'new', 'glitche' ); ?></strong><?php endif; ?></li>
							<?php } ?>
						</ul>
					</div>
					<?php endif; ?>
					<div class="bts">
						<a href="<?php echo esc_url( $item['button']['url'] ); ?>" class="btn fill" data-text="<?php echo esc_html( $item['button']['label'] ); ?>">
							<?php echo esc_html( $item['button']['label'] ); ?>
						</a>
					</div>
				</div>
			</div>
