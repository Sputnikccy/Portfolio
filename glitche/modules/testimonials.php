	...
	<div class="content">
		...
		<div class="reviews-carousel">
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="reviews-item">
							...
							?>
							<div class="image">
								<img src="<?php echo esc_url( $img['sizes']['glitche_100x100'] ); ?>" alt="<?php echo esc_attr( $item['name'] ); ?>" />
							</div>
							<?php endif; ?>
							<div class="info">
								<?php if( $item['name'] ) : ?>
			...
			<div class="swiper-nav">
				<?php if ( $is_navs ) : ?>
				<a class="prev swiper-button-prev ion ion-ios-arrow-back"></a>
				<?php endif; ?>
				<?php if ( $is_dots ) : ?>
				<div class="swiper-pagination"></div>
				<?php endif; ?>
				<?php if ( $is_navs ) : ?>
				<a class="next swiper-button-next ion ion-ios-arrow-forward"></a>
				<?php endif; ?>
			</div>
